...
public class Updateemployee extends JFrame implements ActionListener{
    ...
    Updateemployee(String empId) {
        ...
        JLabel lblname = new JLabel();                     //name not editable   // name chage hot nhi ek cha ahe tya sathi JLabel lavla
        lblname.setBounds(200, 150, 150, 30);
        add(lblname);
        
        JLabel labelfname = new JLabel("Father's Name");                           //fathers name
        labelfname.setBounds(400, 150, 200, 30);
        labelfname.setFont(new Font("serif", Font.PLAIN, 20));
        add(labelfname);
              
        tffname = new JTextField();                                           //fathers block
        ...
        JLabel lbldob = new JLabel();                     //dob not editable   // dob chage hot nhi ek cha ahe tya sathi JLabel lavla
        ...
        JLabel labeleducation = new JLabel("Hig.Education");               //Hig.Education
        labeleducation.setBounds(400, 300, 200, 30);                   
        labeleducation.setFont(new Font("serif", Font.PLAIN, 20));
        add(labeleducation);
        
        tfeducation = new JTextField();                                    //Hig.Education block
        ...
        JLabel lblaadhar = new JLabel();                       // aadhar no pn change nhi hot  
        ...
        lblempId = new JLabel();                                        //EMPLOYEE ID  block
        ...
        try {
            Conn c = new Conn();
            String query = "select * from employee6   where empId = '"+empId+"'";
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                Conn conn = new Conn();                        //je update kariche ahe te khali tyt name ,Dob ,Aadhar nhiye karan te aapan change karat nhi
                String query = "update employee6 set fname = '"+fname+"', salary = '"+salary+"', address = '"+address+"', phone = '"+phone+"', email =  '"+email+"', education = '"+education+"', designation = '"+designation+"' where empId = '"+empId+"'";
